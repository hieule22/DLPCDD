! function(e, t) {
    ...
    var t = function(e, t) {
        ...
        s = function(e, t) {
            var o;
            for (o = 0; o < e.length; o++) e[o] instanceof google.maps.LatLng || (e[o] = e[o].length > 0 && "object" == typeof e[o][0] ? s(e[o], t) : r(e[o], t));
            return e
        },
        i = function(e, t) {
            var o, e = e.replace("#", "");
        ...
        l = function() {
            ...
            var e = document,
                o = function(n) {
                    ...
                    for (1 != n.disableDefaultUI && (x = t(x, C)), M = t(x, n), r = 0; r < l.length; r++) delete M[l[r]];
                    ...
                    var P = function(e, t) {
                        ...
                        if (i("gmaps_context_menu")) {
                            ...
                            p.innerHTML = o;
                            var r, g = p.getElementsByTagName("a"),
                                c = g.length;
                            for (r = 0; c > r; r++) {
                                var h = g[r],
                                    u = function(o) {
    ...
    l.prototype.createControl = function(e) {
        ...
        e.id && (t.id = e.id), e.classes && (t.className = e.classes), e.content && ("string" == typeof e.content ? t.innerHTML = e.content : e.content instanceof HTMLElement && t.appendChild(e.content)), e.position && (t.position = google.maps.ControlPosition[e.position.toUpperCase()]);
        ...
        if ("undefined" == typeof e) {
            for (var o = 0; o < this.markers.length; o++) this.markers[o].setMap(null);
            this.markers = t
        } else {
            for (var o = 0; o < e.length; o++) this.markers.indexOf(e[o]) > -1 && this.markers[o].setMap(null);
            for (var o = 0; o < this.markers.length; o++) null != this.markers[o].getMap() && t.push(this.markers[o]);
            this.markers = t
        }
    ...
    return l.prototype.getRoutes = function(e) {
        ...
        if (i)
            for (var d = 0; d < i.length; d++) {
                var f = [];
                i[d].featureType && f.push("feature:" + i[d].featureType.toLowerCase()), i[d].elementType && f.push("element:" + i[d].elementType.toLowerCase());
        ...
        if (a) {
            ...
            var b = o.path;
            if (b.join)
                for (var _, m = 0; _ = b[m]; m++) a.push(_.join(","));
            else a.push("enc:" + b);
        ...
        if (-1 == l.custom_events.indexOf(e)) return t instanceof l && (t = t.map), google.maps.event.addListener(t, e, o);
        var n = {
            handler: o,
            eventName: e
        };
