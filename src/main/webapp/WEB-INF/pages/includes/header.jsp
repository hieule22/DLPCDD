	...
	<div class="page-header navbar navbar-fixed-top">
			...
			<div class="page-logo" style="float:left;">
					<div style="float:left;">
						<img style="padding-top: 5px;" src="<c:url value="/resources/admin/layout/img/logo.png" />">	
					</div>	
					<div style="float:left;width:135px;">		
						<span style="color:#FFFFFF;float:right; font-weight: bold;">CARDHOLDER DATA </span>
						<p style="float:right; font-size: 16px;"><Strong style="color:red;padding-top: -10px;">DISCOVERY</Strong></p>
					</div>	
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user"><a href="#"
						...
						data-hover="dropdown" data-close-others="true"> <img alt=""
							class="img-circle"
							src="<c:url value="/resources/admin/layout/img/avatar3_small.jpg"/>" />
