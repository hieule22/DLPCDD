...
<link href="<c:url value="/resources/admin/pages/css/googleapis.css"/>"
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">Scan history</div>
						</div>
				...
				<spring:url value="/newScan" var="addUrl" />
				<div class="row">
					<div class="col-md-12 text-right">
						<a type="button" class="btn default green" href="${addUrl}"> <i
							class="fa fa-plus"></i> New scan
						</a>
					</div>
				</div>
				<!-- PAGE END  -->
												...
												<div class="post out">
													...
													<div class="message">
														<span class="arrow"></span> <a href="#" class="name">Bob
															...
															class="body"> When could you send me the report ?
														</span>
													</div>
												</div>
												<div class="post in">
													...
													<div class="message">
														<span class="arrow"></span> <a href="#" class="name">Ella
															...
															class="body"> Its almost done. I will be sending
															it shortly </span>
													</div>
												</div>
												<div class="post out">
			...
			<script
				...
				type="text/javascript"></script>
			<!--[if lte IE 8]>
			<script language="javascript" type="text/javascript" src="<c:url value="/resources/global/plugins/flot/excanvas.min.js"/>"></script>
			<![endif]-->
			<script
				src="<c:url value="/resources/global/plugins/flot/jquery.flot.min.js"/>"></script>
			<script
				src="<c:url value="/resources/global/plugins/flot/jquery.flot.time.js"/>"></script>
			<script
				src="<c:url value="/resources/global/plugins/flot/jquery.flot.axislabels.js"/>"></script>
			<script
				src="<c:url value="/resources/admin/pages/scripts/charts-flotcharts.js"/>"></script>
