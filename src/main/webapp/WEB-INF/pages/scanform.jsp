				...
				<div class="row">
					<div class="col-md-12">
						<form:form class="form-horizontal" method="post" role="form"
							id="validatedForm" action="startScan" commandName="scanForm"
							novalidate="novalidate">
							<div class="form-body">
								<div class="form-group">
									<label class="col-md-2 control-label text-left">Scan
										directories <span class="required" aria-required="true">
											* </span>
									</label>
									<spring:bind path="directories">
										<div class="col-md-6">
											<form:textarea class="form-control" rows="8"
												path="directories" data-required="1" />
											<form:errors path="directories" class="control-label" />
										</div>
									</spring:bind>
									<div class="col-md-2">
