	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<!-- END DASHBOARD STATS -->
				<div class="row">
					<div class="col-md-12">Result for ${resultLog.name}</div>
				</div>
				</br>
				<div class="row">
					<div class="col-md-6">
						<table class="table table-bordered table-hover">
							<tbody>
								<tr>
									<td>Status</td>
									<td class="text-right">${resultLog.status}</td>
								</tr>
								<tr>
									<td>Files Done</td>
									<td class="text-right">${resultLog.filesDone}</td>
								</tr>
								<tr>
									<td>Files Total</td>
									<td class="text-right">${resultLog.filesTotal}</td>
								</tr>
								<tr>
									<td>Bytes Done</td>
									<td class="text-right">${resultLog.bytesDone}</td>
								</tr>
								<tr>
									<td>Bytes Total</td>
									<td class="text-right">${resultLog.bytesTotal}</td>
								</tr>
								<tr>
									<td>Percentage</td>
								...
								<tr>
									...
									<td class="text-right">${resultLog.totalFindCount}</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="row">
					<div class="col-md-6">
						<table class="table table-bordered table-hover text-center">
							...
							<tbody>
								<c:forEach var="row" items="${resultLog.instanceList}" varStatus="status">
									<tr>
										<td>${status.count}</td>
										<td>${row.cardName}</td>
										<td>${row.substring}</td>
										<td>${row.pathname}</td>
										<td>${row.charOffset}</td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
				...
				<div class="row">
					<div class="col-md-6 text-right">
						<a type="button" class="btn default btn-circle" href="scan">Back</a>
					</div>
				</div>
				<!-- END DASHBOARD STATS -->
				<!-- END CONTENT -->
