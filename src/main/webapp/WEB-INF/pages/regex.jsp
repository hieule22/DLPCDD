...
<link href="<c:url value="/resources/admin/layout/css/custom.css"/>"
	rel="stylesheet" type="text/css" />
<!-- DATATABLE -->
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css"/>"/>
<!-- END THEME STYLES -->
<link rel="shortcut icon"
	href="<c:url value="/resources/admin/layout/img/favicon.ico"/>">
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<h3 class="page-title">Regular Expression</h3>
				<!-- END PAGE HEADER-->
				<!-- BEGIN DASHBOARD STATS -->

				<!-- END DASHBOARD STATS -->
				<c:if test="${not empty success}">
					<div id="successMsg" class="Metronic-alerts alert alert-success fade in" style="display: block;">
						<button class="close" data-close="alert"></button>
						${success}
					</div>
				</c:if>
				<c:if test="${not empty error}">
					<div id="successMsg" class="alert alert-danger display-hide" style="display: block;">
						<button class="close" data-close="alert"></button>
						${error}
					</div>
				</c:if>
				<spring:url value="/regex/add" var="addUrl" />
				<spring:url value="/regex/deleteSelected" var="deleteSelectedUrl" />
				<form:form class="form-horizontal" method="post" role="form"
					action="${deleteSelectedUrl}" commandName="regexForm">
					<div class="row">
						<div class="col-md-12 text-right">
							<a type="button" class="btn default green" href="${addUrl}">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">Are you sure you want to
									delete this Regular Expression?</div>
								<div class="modal-footer">
									<button type="button" class="btn btn-sm default"
										data-dismiss="modal">Close</button>
									<a type="button" class="btn btn-sm red"
										id="btnConfirmDelete"><i class="fa fa-times"></i>
										Delete</a>
								</div>
							</div>
							<!-- /.modal-content -->
					...
					<div class="row">
						<div class="col-md-12">
							<table id="regex_table" class="table table-striped table-bordered table-hover text-center">
								<thead>
									<tr>
										<th class="text-center">#ID</th>
										<th class="text-center">Regex Name</th>
								...
								<tbody>
									<c:forEach var="row" items="${regexForm.regularExpressions}"
										varStatus="statusItem">
										<spring:url value="/regex/${row.id}/update" var="updateUrl" />
										<spring:url value="/regex/${row.id}/delete" var="deleteUrl" />
										<c:choose>
											<c:when test="${statusItem.index mod 2 eq 0}">
												<tr class="even">
											</c:when>
											<c:otherwise>
												<tr class="odd">
											...
											<td class="col-md-6">${row.regex}</td>
											<td class="col-md-2"><a type="button" class="btn btn-sm blue"
												href="${updateUrl}"><i class="fa fa-edit"></i> Edit</a> <a
												type="button" class="btn btn-sm red confirmDelete" data-toggle="modal"
												href="${deleteUrl}" onclick="$(this).ShowConfirmDialog(event);"><i class="fa fa-times"></i>
													Delete</a></td>
										</tr>
									</c:forEach>
									</form:form>
									...
									<div class="page-quick-sidebar-chat-user">
										...
										<div class="page-quick-sidebar-chat-user-messages">
											...
											<div class="post in">
												...
												<div class="message">
													<span class="arrow"></span> <a href="#" class="name">Ella
														Wong</a> <span class="datetime">20:15</span> <span
														class="body"> Its almost done. I will be sending it
														shortly </span>
												</div>
											</div>
											<div class="post out">
											...
											<div class="post in">
												...
												<div class="message">
													<span class="arrow"></span> <a href="#" class="name">Ella
														Wong</a> <span class="datetime">20:16</span> <span
														class="body"> You are most welcome. Sorry for the
														delay. </span>
												</div>
											</div>
											<div class="post out">
											...
											<div class="post in">
												...
												<div class="message">
													<span class="arrow"></span> <a href="#" class="name">Ella
														Wong</a> <span class="datetime">20:40</span> <span
														class="body"> Alright. I just emailed it to you. </span>
												</div>
											</div>
											<div class="post out">
												<img class="avatar" alt=""
											...
											<div class="post in">
												...
												<div class="message">
													<span class="arrow"></span> <a href="#" class="name">Ella
														Wong</a> <span class="datetime">20:40</span> <span
														class="body"> Please let me know if you have any
														comment. </span>
												</div>
											</div>
											<div class="post out">
													...
													<div class="cont-col2">
														<div class="desc">
															You have 4 pending tasks. <span
																class="label label-sm label-warning "> Take
		...
		<script src="<c:url value="/resources/admin/layout/scripts/demo.js"/>"
			type="text/javascript"></script>
		<script type="text/javascript" src="<c:url value="/resources/global/plugins/datatables/media/js/jquery.dataTables.min.js"/>"></script>
		<script type="text/javascript" src="<c:url value="/resources/global/plugins/datatables/extensions/TableTools/js/dataTables.tableTools.min.js"/>"></script>
		<script type="text/javascript" src="<c:url value="/resources/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.js"/>"></script>
		<script type="text/javascript" src="<c:url value="/resources/admin/pages/scripts/table-advanced.js"/>"></script>	
		...
		<script>
			jQuery(document).ready(function() {
			    ...
			    $.fn.ShowConfirmDialog = function(ev) {
